...
const Header = () => {
  return (
    <>
      <div className=" bg-red-500/35 flex justify-between items-center h-14 fixed top-0 left-0 right-0 pl-8 pr-5 w-[100%]     md:fixed md:top-0 md:left-0 md:right-0 md:w-[100%] md:h-14 md:bg-red-500/35 md:flex md:justify-between md:items-center md:pl-16 md:pr-16">
        <ul className=" md:flex md:gap-5">
          <li className="text-2xl text-green-600 font-stretch-105% cursor-pointer font-bold  md:cursor-pointer md:text-3xl md:font-bold md:text-green-500/100 ">
            GREENMIND
          </li>
